...
- [Установка](#установка)
- [Как работает скилл](#как-работает-скилл)
  - [Принцип: Hub → Reference Files](#принцип-hub--reference-files)
  - [Автоматическая активация](#автоматическая-активация)
- [Циклы работы](#циклы-работы)
  - [Создание новой сущности](#цикл-1-создание-новой-сущности)
  - [Code Review](#цикл-2-code-review)
  - [Фикс конкретного слоя](#цикл-3-фикс-конкретного-слоя)
  - [Quality Gates](#цикл-4-quality-gates-перед-коммитом)
- [Многопоточная работа](#многопоточная-работа)
  - [Claude Code Agents](#через-claude-code-agents-agent-tool)
  - [Subagent-Driven Development](#через-superpowers-subagent-driven-development)
  - [Ralph Loop — авто-цикл ревью→фикс](#через-ralph-loop--автоматический-цикл-ревьюфиксревью)
  - [Loop Skill — мониторинг](#через-loop-skill--периодический-мониторинг)
- [Superpowers — Структурированная разработка](#superpowers--структурированная-разработка)
  - [Pipeline: от идеи до merge](#pipeline-от-идеи-до-merge)
  - [Сквозные дисциплины](#сквозные-дисциплины-применяются-на-каждом-шаге)
- [BMAD Method — AI Agile Framework](#bmad-method--ai-agile-framework)
- [GSD (Get Shit Done) — Spec-Driven Development](#gsd-get-shit-done--spec-driven-development)
- [Сравнение методологий](#сравнение-методологий)
- [Архитектура скилла](#архитектура-скилла)
- [Контекстная эффективность](#контекстная-эффективность)
